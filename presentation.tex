...
\begin{document}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % SLIDE 2: Motivation --- subsurface characterization
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{frame}{Motivation: Subsurface characterization}

        \textbf{Reservoir characterization:} Determine petrophysical properties of excavated rocks (porosity, saturation, permeability).

        \vspace{0.5em}
        \textbf{Lithology interpretation:} Identify rock types from drilling measurements --- foundational for subsurface exploration, geothermal energy and oil \& gas.

        \vspace{0.5em}
        \textbf{Current practice:} Visual analysis of drilled cuttings under microscopes.
        \begin{itemize}
            \item Grain size/shape, colour, texture, mineral composition
            \item Labor-intensive, expert-dependent, prone to contamination
        \end{itemize}

        \pause
        \vspace{0.5em}
        \textbf{Our vision:} Online tomographic imaging of cuttings as they are discharged into a collection pit --- a fixed-geometry CT system with high throughput.

        \note{Explain the application: geological drilling produces cuttings that need characterization. Currently done manually under microscopes. We want to automate this with CT.}
    \end{frame}
