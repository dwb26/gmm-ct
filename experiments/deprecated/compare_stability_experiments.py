#!/usr/bin/env python3
"""
DEPRECATED — This file has been superseded by experiments/stability/compare_stability_experiments.py.
It is retained here for reference only and may not run without modification.
